...
_C.CKPT_DIR = '/data1/fjw/JAAD/JAAD/checkpoints'
_C.OUT_DIR = '/data1/fjw/JAAD/JAAD/outputs'
_C.DEVICE = 'cuda'
_C.METHOD = 'BiTraPNP'
_C.GPU = '0'
_C.VISUALIZE = False
...
_C.DATASET.ROOT = '/data1/fjw/JAAD/JAAD/'
_C.DATASET.TRAJECTORY_PATH = '/data1/fjw/JAAD/JAAD/trajectories/'
_C.DATASET.FPS = 30
